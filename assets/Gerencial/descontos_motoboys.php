...
<main class="corpo">
    <div class="container">
        ...
        ?>
        <h4 class="text-center">Descontos - Motoboy</h4>
        <div class="row">
                    ...
                    <div class="card shadow">
                        <div class="my-3 mx-3">
                            <div class="text-center">
                                <p><small>Selecione o motoboy, data e desconto.</small></p>
                            </div>
                            <form action="?pagina=Gravar-Desconto-Motoboy" method="post">
        ...
        <?php
        $bDescMot = "SELECT * FROM descontos_motoboys";
        $bDescMotExec = mysqli_query($conn, $bDescMot);
        $bDescMotResult = mysqli_num_rows($bDescMotExec);
        ...
        if ($bDescMotResult > 0) { ?>
            <div class="my-3">
                ...
                <table class="table table-sm table-hover display">
                    ...
                    <tbody>
                        <?php
                        while ($result = mysqli_fetch_assoc($bDescMotExec)) { ?>
                            <tr>
