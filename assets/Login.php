...
<html lang="pt-br">
  ...
  <body style="background-color: #38a3a5;">
    <div class="text-center mt-5">
        <img src="img/Logo-Pandora.png" alt="">
    </div>
    <div class="row mt-4">
        <div class="col col-4">
            ...
            <div class="card">
                <div class="ml-5 mr-5 mt-5 mb-5">
                    <div class="text-center mb-2">
                        ...
                        <span>Por favor digite suas credenciais</span>
                    </div>
                    ...
                    <button class="mt-2 align-right btn btn-lg btn-info" type="submit">Entrar</button>
                </div>
            </div>
        </div>
        <div class="col col-4">
